...
def sort_by_most_hobbies(people_list: list) -> list:
    ...
    """
    yabadaba = []
    for bprice in people_list:
        yabadaba.append(bprice)
    b_sorted = sorted(yabadaba, key = lambda yabadaba : (len(yabadaba.hobbies) * -1, yabadaba.first_name))
    return b_sorted
    pass
...
def sort_by_least_hobbies(people_list: list) -> list:
    ...
    for bprice in people_list:
        yabadaba.append(bprice)
    b_sorted = sorted(yabadaba, key = lambda yabadaba : (len(yabadaba.hobbies), yabadaba.first_name))
    return b_sorted
    pass
...
def sort_people_and_hobbies(people_list: list) -> list:
    ...
    for bprice in people_list:
        yabadaba.append(bprice)
        bprice.hobbies.sort()
    n_sorted = sorted(yabadaba, key = lambda yabadaba : yabadaba.first_name)
    return n_sorted
    pass
